"""
Weather Temperature Prediction Model - Phase 0
...
print("="*80)
print("PHASE 0: Temperature Prediction Model")
print("="*80)
...
clean_df, _, _ = dm.load_and_process_data(run_plots=False, save_plots=False)

# Define features (12 variables - excluding PP and QQ due to contamination)
FEATURE_COLS = [
    'TG',  # Mean Temperature (includes for autocorrelation)
    'TN', 'TX',  # Min/Max Temperature
    'RR',  # Precipitation
    'SS',  # Sunshine
    'HU',  # Humidity
...
for i in range(len(feature_data) - INPUT_DAYS - FORECAST_DAYS + 1):
    # Input: 30-day window of all 12 features
...
print(f"  X_data shape: {x_data.shape}  # (samples, 30 days, 12 features)")
